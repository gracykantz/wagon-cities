export default function(state = null, action) {
  ...
  default: {
    return [
      ...
      { name: 'London', address: '14-22 Elder St, London E1 6BT', slug: 'london' },        { name: 'Berlin', address: 'Rudi-Dutschke-Straße 26, 10969 Berlin', slug: 'berlin' },
      ...
      { name: 'Montréal', address: '5333, avenue Casgrain, 102, Montréal (Québec), H2T1X3', slug: 'montreal' },      { name: 'Tokyo', address: '2-11-3 Meguro, Meguro-ku, Tokyo ', slug: 'tokyo' },
